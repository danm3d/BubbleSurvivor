...
public class BubbleBehaviour : MonoBehaviour
{
    ...
    //will balls stay still on start?
    ...
    //hcmode=force added in the direction of the player
    public GameObject player;
    //reference to the player, used for hc mode
    ...
    {
        Vector3 dir = transform.position - (Vector3)coll.contacts [0].point;
//        dir.y = directionAdjustment.y;
//        dir.z = directionAdjustment.z;
        transform.right = dir;
...
//        MyCollider.radius = scale / 2f;
    ...
    private void SpawnForce()
    {
        ...
        if (!hcMode)
        {
            myRigidbody.velocity = new Vector2(Random.Range(5f, 10f) * ((float)(Random.Range(0, 2) * 2) - 1), Random.Range(3f, 7f) * ((float)(Random.Range(0, 2) * 2) - 1));
        } else
        {
            ...
            myRigidbody.velocity = new Vector2(Random.Range(direct.normalized.x * 5f, direct.normalized.x * 10f), Random.Range(direct.normalized.y * 5f, direct.normalized.y * 10f));
        }
    }
